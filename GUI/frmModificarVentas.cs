...
namespace GUI {
    public partial class frmModificarVentas : Form {
        public Solicitudes objSolicitud;
        public frmModificarVentas() {
            InitializeComponent();
        }

        public frmModificarVentas(int id_material) : this() {
            try {
                objSolicitud = new DAOVenta().obtenerUno(id_material);
                txtCliente.Text = objSolicitud.NombreCliente;
                txtProducto.Text = objSolicitud.NombreProducto;
